...
import type { GroupAgent, GroupMode, GroupSendResponse, GroupSnapshot, StoredMember } from "../model/types";
...
export const groupApi = {
  ...
  updateAgentSettings: (agentId: string, model: string, reasoningEffort: string, signal?: AbortSignal) => postJson<GroupAgent>(
