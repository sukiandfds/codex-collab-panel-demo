...
| `FEAT-018` | 系统级 Goal 持续目标与协调能力 | `implemented_pending_review` | `v0.1.1` | 2026-08-14 | Goal 生命周期、精确 Turn 关联、终态自动回写、关系保护、明确目标操作和停止状态边界已完成审查修复；UI 构建及 Windows 160 项测试通过，等待服务重启后的真实长任务和跨入口体验验收 | [`FEAT-018-system-goal-orchestration.md`](./features/FEAT-018-system-goal-orchestration.md) |
