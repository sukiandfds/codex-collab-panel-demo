...
| --- | --- | --- | --- | --- | --- | --- |
| `FEAT-001` | 单人 Codex Web 对话与控制 | `implemented_pending_review` | `v0.10.3` | 2026-07-29 23:30 +08:00 | 图片工具输出和手机比例已修复；P0：页面仍不能可靠区分正常静默执行、等待重启与真正卡死，下一步必须先复用既有开源调研，停止叠加状态补丁 | [`FEAT-001-single-codex-web.md`](./features/FEAT-001-single-codex-web.md) |
...
| --- | --- | --- | --- |
| `P1` | `FEAT-001-I08` / `I15` 持续过程同步 | 在原开发电脑验收已完成的事件重放、断档识别和快照补偿 | 使用 5 分钟以上真实任务、断网重连、后台切回和完成事件遗漏；不用高频整页轮询掩盖问题 |
